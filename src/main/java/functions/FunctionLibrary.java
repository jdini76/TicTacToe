...
public class FunctionLibrary {
	...
	public void openPhrase() {
		loginfo("#######################################################");
		loginfo("Greetings Professor Falken. Would you like to play a game?");
		loginfo("Number of Players: 0");
		loginfo("#######################################################");
	}
	
	public void endPhrase() {
		loginfo("#######################################################");
		loginfo("Interesting game. The only way to win is not to play.");
		loginfo("How about a nice game of Chess.");
		loginfo("#######################################################");
	}
